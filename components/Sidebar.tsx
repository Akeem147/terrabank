      ...
      <nav className="flex flex-col gap-4 bg-slate-100 bg-opacity-5">
        ...
        >
          <Image
              ...
              height={30}
            />
          <h1 className="sidebar-logo">Terrabank</h1>
        </Link>
      ...
      <div className="mt-auto p-4 flex flex-col items-start">
        <div className="flex items-center gap-1">
          ...
          <div className="flex flex-col text-black mb-2">
            <h5 className="text-black font-semibold text-sm">Brain Willy</h5>
            <p className="text-black text-xs">brainwilly19@gmail.com</p>
          </div>
        </div>
        <button
